...
<body>
    ...
    <!-- Premium custom styles to support the tabbed layout and the modern timeline -->
    <style>
        .about-modern-layout {
            max-width: 54rem !important; /* Slightly wider for cards and timeline panels */
        }
        .about-card, .timeline-intro-card, .timeline-era-card, .proposal-section {
            background: #fff;
        ...
        .about-card h2, .timeline-era-card h3, .proposal-section h2 {
