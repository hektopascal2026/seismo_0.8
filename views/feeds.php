        ...
        <div class="latest-entries-section">
            ...
            <form method="post" action="<?= e($basePath) ?>/index.php?action=feed_save" class="admin-form-card" id="feed-source-form">
                ...
                <div class="admin-help">
                    For <strong>parl_press</strong>, set the SharePoint list <code>…/items</code> URL per stream. <strong>Medienmitteilungen</strong> (<code>guid_prefix</code> <code>parl_mm</code>): <code>https://www.parlament.ch/press-releases/_api/web/lists/getByTitle('Pages')/items</code> — Seismo uses search <strong>POST</strong> + OData fallback. <strong>SDA-Meldungen</strong> (<code>parl_sda</code>): <code>https://www.parlament.ch/de/services/news/_api/web/lists/getByTitle('Seiten')/items</code> — list GET only (separate news site). Example Medien JSON: <code>{"lookback_days":90,"limit":50,"language":"de"}</code>. Example SDA JSON: <code>{"lookback_days":365,"limit":80,"language":"de","guid_prefix":"parl_sda"}</code> — set <strong>Category</strong> to <code>parl_sda</code> for the timeline pill.
                </div>
                <?php endif; ?>
                <div class="admin-form-field">
