<?php
/**
 * Seismo 0.6 Standalone Design Showcase & Sandbox Basis.
 * This is a completely isolated design blueprint and interactive styleguide.
 * It does NOT modify or override any production styles or controllers.
 * Open this in your browser: http://localhost:8000/design_showcase.php
 */
...
<head>
    ...
    <title>Interactive Design Showcase & styleguide — <?= e($brandTitle) ?></title>
    ...
    <style>
        ...
        * {
        ...
        aside.showcase-sidebar {
            position: sticky;
            top: var(--space-4xl);
            height: calc(100vh - var(--space-5xl));
            display: flex;
        ...
        /* ═══ RECONSTRUCTED CSS SHIELD (THE CLEAN SYSTEM) ═══ */
        
        /* 1. MASTER INTERACTIVE SELECTORS */
        ...
        <main class="showcase-content">
            ...
            <section id="cards" class="showcase-section">
                ...
                <div style="margin-bottom: var(--space-4xl);">
                    <h3 style="font-family: var(--mono-font); font-size: 0.8rem; font-weight: 700; color: #555; margin-bottom: var(--space-sm);">1. RSS Feed / Substack Card</h3>
                ...
                <div style="margin-bottom: var(--space-4xl);">
                    <h3 style="font-family: var(--mono-font); font-size: 0.8rem; font-weight: 700; color: #555; margin-bottom: var(--space-sm);">2. Scraper Hydrated Card</h3>
                    <div class="timeline-card">
                        <div class="card-header-bar">
                ...
                <!-- LEX CARD -->
                <div style="margin-bottom: var(--space-4xl);">
                    <h3 style="font-family: var(--mono-font); font-size: 0.8rem; font-weight: 700; color: #555; margin-bottom: var(--space-sm);">3. Swiss Legislation (CH Lex / Fedlex) Card</h3>
                    <div class="timeline-card">
                        <div class="card-header-bar">
                            <span class="pill-source" style="background-color: var(--pill-lex-ch); border-color: var(--color-border);">CH LEX (FEDLEX)</span>
                            <div style="display: inline-flex; align-items: center; gap: var(--space-sm); margin-inline-start: auto;">
                ...
                <!-- PARLAMENT LEG CARD -->
                <div style="margin-bottom: var(--space-4xl);">
                    <h3 style="font-family: var(--mono-font); font-size: 0.8rem; font-weight: 700; color: #555; margin-bottom: var(--space-sm);">4. Parliamentary Deliberation (CH Leg) Card</h3>
                    <div class="timeline-card">
                        <div class="card-header-bar">
                            <span class="pill-source" style="background-color: var(--pill-leg);">CH LEG (PARLAMENT)</span>
                            <div style="display: inline-flex; align-items: center; gap: var(--space-sm); margin-inline-start: auto;">
                ...
                <!-- MAIL CARD -->
                <div>
                    <h3 style="font-family: var(--mono-font); font-size: 0.8rem; font-weight: 700; color: #555; margin-bottom: var(--space-sm);">5. Email Ingest Card</h3>
                    <div class="timeline-card">
                        <div class="card-header-bar">
...
.view-toggle-bar a, .nav-link, .label-btn {
    ...
    font-weight: 600;
    transition: transform 0.1s ease, box-shadow 0.1s ease, background-color 0.1s ease;
    box-shadow: 0.125rem 0.125rem 0 #000000; /* Flat default shadow */
    cursor: pointer;
    text-decoration: none;
    display: inline-flex;
    align-items: center;
...
.view-toggle-bar a:hover, .nav-link:hover, .label-btn:hover {
    transform: translate(-1px, -1px);
    box-shadow: 0.1875rem 0.1875rem 0 #000000; /* Expanded 3px shadow */
    background-color: #fff9e6; /* Soft cream hover overlay */
}

/* 3D Pressed Active State */
.btn:active, .btn.active, 
.top-bar-btn:active, .top-bar-btn.active, 
