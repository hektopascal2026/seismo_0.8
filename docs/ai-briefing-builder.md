...
| Gemini pass-2 output | Scales **~1100 visible tokens per cited item** (floor 2048, practical cap **24576**). Override via `gemini:max_output_tokens` in `system_config`. Multi-section prompts (e.g. legal blocks per item) need this headroom. |
